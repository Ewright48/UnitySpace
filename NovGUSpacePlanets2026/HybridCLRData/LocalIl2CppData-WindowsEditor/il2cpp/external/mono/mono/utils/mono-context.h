...
#if defined(HAVE_SIGACTION) || defined(__APPLE__) || defined(__QNX__) // the __APPLE__ check is required for the tvos simulator, which has ucontext_t but not sigaction
