...
#undef COMPILER_MSVC_EMULATED_BY_CLANG
#if defined(DETAIL__TEMP_COMPILER_MSVC_EMULATED_BY_CLANG_WAS_1)
    #undef DETAIL__TEMP_COMPILER_MSVC_EMULATED_BY_CLANG_WAS_1
